...
public class LaneConnection {
    ...
    /**
     * Checks if this LaneConnection is a pedestrian connection.
     * @return true if the ingress lane is a pedestrian Lane, false otherwise
     */
    ...
    /**
     * Determines if this LaneConnection crosses another Lane.
     *
     * @param otherLane the other LaneConnection to check against
